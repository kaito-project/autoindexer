...
import (
	...
	"github.com/kaito-project/autoindexer/pkg/autoindexer/controllers"
	"github.com/kaito-project/autoindexer/pkg/autoindexer/webhooks"
...
func main() {
	...
	if enableWebhook {
		...
		go sharedmain.MainWithConfig(ctx, "webhook", ctrl.GetConfigOrDie(), webhooks.NewAutoIndexerWebhooks()...)
